#include "tests/01-generator/coroutines/Generator.h"
...
TEST_F(Demo01GeneratorCoroutines, FibonacciSecondPassExhausted) { EXPECT_TRUE(fibonacci_second_pass_is_exhausted()); }
